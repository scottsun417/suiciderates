...
---
title: "Within-Participant Analysis (child and adult)"
output:
...
data %>% 
  ...
  theme(panel.spacing.x = unit(2, "mm"), legend.key.height= unit(0.4, 'cm'), 
        legend.key.width= unit(0.4, 'cm'), legend.key.size = unit(0.1, 'cm'),
...
ggplot(changepoints_variability, aes(x = participant, y = sd_changepoints, fill = participant)) +
  ...
  theme(panel.spacing.x = unit(2.5, "mm"), legend.key.height= unit(0.4, 'cm'), 
        legend.key.width= unit(0.4, 'cm'), legend.key.size = unit(0.1, 'cm'),
        legend.text = element_text(size=6), strip.text.x = element_text(size = 8)) +
